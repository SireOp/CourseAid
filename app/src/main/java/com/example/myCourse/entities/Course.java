...
public class Course {
    ...
    public Course(Integer courseId, String title, LocalDate startDate, LocalDate endDate, String status, String notes, String courseInfo, String instructorName, String phone, String email, Integer termId) {
